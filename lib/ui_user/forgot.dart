  ...
  sendOTP(String mobile, String otp) async {
    ...
    if (response.statusCode == 200) {
      ...
      scaffoldKey.currentState.showSnackBar(SnackBar(
          content: new Text("OTP a été envoyé avec succes"),
      ...
      children: <Widget>[
        ...
        new Padding(
          ...
          child: RaisedButton(
            ...
            color: Colors.lightBlueAccent,
            child: Text('Reinitialiser', style: TextStyle(color: Colors.white)),
          ),
        ),
        new FlatButton(
          onPressed: _sendToLoginPage,
          child: Text('Vous etes deja membre? Connectez-Vous maintenant',
              style: TextStyle(color: Theme.of(context).accentColor)),
        ),
        new FlatButton(
          onPressed: _sendToRegisterPage,
          child: Text('Pas un membre? inscrivez vous maintenant',
              style: TextStyle(color: Theme.of(context).accentColor)),
        ),
      ],
    );
