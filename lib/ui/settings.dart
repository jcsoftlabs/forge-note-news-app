...
class _ProfileState extends State<Profile> {
    ...
    try {
      ...
      setState(() {
        ...
        _name = prefs.getString("name") == null
            ? "Connectez-vous s'il vous plait"
  ...
  List items = [
    ...
    {"icon": Icons.brightness_6, "title": "Mode Sombre"},
    {
      "icon": Icons.info,
      "title": "A propos",
      "page": About(),
        ...
        children: <Widget>[
          ...
          ListView.separated(
            ...
            itemBuilder: (BuildContext context, int index) {
              if (items[index]['title'] == "Mode Sombre") {
              ...
              if (items[index]['title'] == "Déconnexion" ||
                  items[index]['title'] == "Connexion") {
                items[index]['title'] =
                    isLogin == "0" ? "Connexion" : "Déconnexion";
              }
              return ListTile(
                onTap: () {
                  if (items[index]['title'] == "info") {
                  } else if (items[index]['title'] == "Déconnexion") {
                    ...
                    Scaffold.of(context).showSnackBar(SnackBar(
                        content:
                            new Text("Vous avez eté déconnecté avec succes!"),
                        duration: const Duration(milliseconds: 500)));
                  } else if (items[index]['title'] == "Connexion") {
                    _sendToLoginPage();
                  } else {
